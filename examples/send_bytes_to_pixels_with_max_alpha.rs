...
fn main (){
    ...
    vec.extend_from_slice(&[255,0,0,100, 255,0,0,200, 255,0,0,120, 255,0,0,200, 255,0,0,180, 255,0,0,255, 255,0,0,100]); // 7 BLUE pixels
    vec.extend_from_slice(&[255,0,0,200, 255,0,0,0, 255,0,0,10, 255,0,0,100, 255,0,0,225, 255,0,0,255, 255,0,0,255]); // 7 BLUE pixels
