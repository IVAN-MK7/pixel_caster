use pixel_caster::{*, pixels_string::*};
...
fn char_collection_alteration() {
    ...
    crate::Screen::update_area_custom(
        ...
        0, pixels_string_black_transparent_background.pixels.height as i32,
    ...
    crate::Screen::update_area_custom(
        ...
        0, pixels_string_black_transparent_background.pixels.height as i32 * 2,
...
fn copy_and_paste_pixels() {
    ...
    println!("screen_u8.bytes: first value: {}, length: {}", screen_u8.get_bytes()[0], screen_u8.get_bytes().len());
    println!("screen_u8.bytes: first pixel's values: B:{} G:{} R:{} A:{}", screen_u8.get_bytes()[0], screen_u8.get_bytes()[1], screen_u8.get_bytes()[2], screen_u8.get_bytes()[3]);
...
fn copy_and_paste_pixels_slimmed() {
    ...
    let mut screen_u8_dst :Screen<u8> = Screen::new(screen_area_to_capture_upperleftcorner_x+100, screen_area_to_capture_upperleftcorner_y+100, pixels_width, pixels_height);
